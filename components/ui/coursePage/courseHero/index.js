                    ...
                    <div className="mt-2 md:mt-4 lg:mt-10">
                        <div>
                            <div className="flex flex-wrap lg:flex-nowrap ">
                                <div action="" className=" flex flex-col sm:flex-row w-full lg:w-auto py-1">
                                    <input type="email" placeholder="Enter email" className="h-12 px-3 placeholder:text-lg placeholder:font-light rounded-sm mt-2 w-full lg:max-w-[190px]" />
                                        <button className={`${Hero.buttonColor} px-5 flex justify-center items-center mt-2 rounded-sm w-full lg:max-w-[190px]`} onClick={handleOpen}>
                                            <div className="  ">
                                                <div className="font-bold whitespace-nowrap pt-px">Enroll for free</div>
                                                <div className="text-sm pb-1">{Hero.Enroll_for_free}</div></div>
                        ...
                        <h3 className="text-white mt-10 text-lg pb-4">
                            <span className="font-bold"> {Hero.already_enrolled}</span> already enrolled </h3>
                    </div>
                </div>

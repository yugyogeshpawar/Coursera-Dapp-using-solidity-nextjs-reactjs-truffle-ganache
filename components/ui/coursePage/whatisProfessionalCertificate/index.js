    ...
    <div className=" flex flex-col w-full items-center mt-8">
      ...
      <div className="md:px-8 max-w-7xl my-6 w-full grid place-content-start grid-cols-1 lg:grid-cols-2 ">
        <div className="px-2">
          ...
          <div className="text-2xl font-light">Hands-On Projects</div>
          <div className=" text-gray-700 my-3 ">
          ...
          <div className="text-2xl font-light">Earn a Career Credential</div>
          <div className=" text-gray-700 my-3 ">
        ...
        <div className="w-full grid place-content-center grid-cols-1">
          <img
            ...
            src={`/images/lady_looking_at_computer.png`}
          />
        </div>
      </div>
    </div>

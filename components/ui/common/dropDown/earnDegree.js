    ...
    <>
      <div className="my-10 px-6 w-[80vw]">
        ...
        <div className="my-10 grid grid-cols-2">
          {EarnADegree2.map((data) => (
            <div key={data.title} className="px-6">
              <div className="font-semibold  border-b-2 border-blue-200 mt-5 mb-2">
                {data.title}
              </div>
              {data.data.map((data2) => (
                <div key={data2.id}>
        ...
        <div className=" px-6 ">
          ...
          <div className="flex">
            <div className="w-2/5">
              <div>Big Data MasterTrack® Certificate</div>
              <div>Degree credit•Expert feedback</div>
            </div>

            <div className="w-2/5 px-6">
              <div>
                Innovation Management & Entrepreneurship MasterTrack®
                Certificate
              </div>
              <div>Degree credit•Expert feedback</div>
            </div>
          </div>
          <div className="py-6">View all MasterTrack Certificates</div>
        </div>
      </div>
    </>
  );

                ...
                <div className="max-w-8xl items-center w-full justify-center flex">
                    <div className='max-w-[436px] lg:max-w-3xl px-4 mx-2 lg:ml-10 sm:w-3/5 justify-center '>
                        ...
                        <div className='flex flex-col sm:flex-row justify-center m-0 max-w-md sm:pl-3'>
                            ...
                            <button onClick={handleOpen} className='bg-blue-600 rounded py-3 w-full mb-6 px-5  md:px-8 text-white font-bold mx-2 whitespace-nowrap' >
                                Join for Free
                            </button>

                            <button className='bg-white border-2 border-blue-600 text-blue-600 rounded py-3 w-full mb-6 px-8 font-bold sm:mx-5 whitespace-nowrap mx-2'>Try Coursera For Business</button>
                        </div>
                    </div>

  ...
  return (
    <div className="flex items-center shadow-md fixed top-0 z-50 bg-white w-full justify-center ">
      <div className="w-full max-w-8xl flex  items-center justify-between">
        ...
        <div
          className="py-6 space-y-[6px] pl-4 lg:hidden"
        ...
        <div className="flex justify-center items-center my-1 lg:mr-8">
          <Link href={"/"}>
            <img
              src="/coursera_logo.svg"
              alt="logo"
              className="w-32 md:m-3 lg:w-32 md:mx-6 cursor-pointer"
            />
          </Link>

          <HtmlTooltip
            title={
              <div className="w-80 cursor-context-menu pl-2 pr-6 ">
                ...
                >
                  <div className="flex justify-between items-center">
                    <div className="py-1">Earn a Degree</div>{" "}
                    <span>&#10140;;</span>
                  </div>
                </HtmlTooltip>
            ...
            <form action="" className="relative">
              <div className="max-w-lg">
                <input
                  ...
                  className="border-[1px] border-gray-700 p-2  h-full"
                />
                <img
                  src="/svg/search.svg"
                  alt="logo"
                  className=" absolute stroke-white invert hover:bg-blue-800
        ...
        <div className="lg:flex hidden">
          <ul className="flex justify-center items-center text-sm font-semibold">
            <Link href="/course">
              <li className="whitespace-nowrap px-2 hover:underline hover:text-blue-600 cursor-pointer ">
                Online Degrees{" "}
              </li>
            </Link>
            <Link href="/course">

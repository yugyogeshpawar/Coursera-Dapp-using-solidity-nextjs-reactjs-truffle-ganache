...
function index({ course, onClose, onSubmit, isNewPurchase }) {
    ...
    return (
        <Box sx={style} className="  lg:rounded-xl overflow-y-scroll rounded-md">
            <div className=' justify-center w-full flex flex-col min-w-fit'>

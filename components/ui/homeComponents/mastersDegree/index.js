        ...
        <div className='flex w-full justify-center'>
            ...
            <div className="my-8 max-w-8xl w-full">
                <div className="my-4 lg:mx-20 mx-6 md:mx-12">
                    <div className="text-xl font-semibold text-blue-900">Master's and Bachelor's Degrees</div>
                    <div className="my-6 text-4xl">Find a top degree that fits your life</div>
                    <div className="text-xl mb-10">Breakthrough pricing on 100% online degrees from top universities.
                    </div>
                </div>
